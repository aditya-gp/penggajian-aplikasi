...
<div class="alert alert-info">Menampilkan Data Kehadiran Pegawai Bulan: <span class="font-weight-bold"><?php echo $bulan ?></span> Tahun: <span class="font-weight-bold"><?php echo $tahun ?></span>
</div>
...
<table class="table table-bordered table-striped">
    ...
    <?php $no=1; foreach ($input_absensi as $a) : ?>
        <tr>
            ...
            <td><input type="number" name="hadir[]" class="form-control" value=""></td>
            <td><input type="number" name="sakit[]" class="form-control" value=""></td>
            <td><input type="number" name="alpha[]" class="form-control" value=""></td>
        </tr>
