<div class="container-fluid">
    ...
    <a class="btn btn-sm btn-success mb-2 mt-2" href="<?php echo base_url('admin/dataJabatan/tambahData') ?>"><i class="fas fa-plus">Tambah Data</i></a>
    ...
    <table class="table table-bordered table-striped">
    	...
    	<?php $no=1; foreach ($jabatan as $j) : ?>
    		<tr>
    			...
    			<td><?php echo number_format($j->tj_transport,0,',','.') ?></td>
    			<td><?php echo number_format($j->uang_makan,0,',','.') ?></td>
    			<td><?php echo number_format($j->gaji_pokok + $j->tj_transport + $j->uang_makan,0,',','.') ?></td>
    			<td>
    				<center>
